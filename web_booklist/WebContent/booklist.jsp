...
ResultSet myResultSet = stmt.executeQuery("SELECT bookname, publisher, price, bookid FROM BOOK");
%>
<html>
...
<table border="1" cellspacing="0" width="400" bordercolor="#9AD2F7"
		bordercolordark="white" borderclorlight="#B9E0FA">
		<tr>
			...
			<td width="50" height="20" bcolor="#D2E9F9">
				<p align="center">
